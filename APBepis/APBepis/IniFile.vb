Public Class IniFile
    ...
    Private Declare Ansi Function GetPrivateProfileString Lib "kernel32.dll" Alias "GetPrivateProfileStringA" _
      (ByVal lpApplicationName As String, ByVal lpKeyName As String, ByVal lpDefault As String, ByVal lpReturnedString As System.Text.StringBuilder, ByVal nSize As Integer, ByVal lpFileName As String) As Integer
...
#Enable Warning BC42105 ' Function doesn't return a value on all code paths
    ...
    End Sub
End Class
'Source h ttps://www.developer.com/microsoft/dotnet/ini-files-will-never-die-how-to-in-net/